      ...
      <div className="px-[18px] py-4 pb-24">
        ...
        <div className="flex items-start justify-between mb-6 pb-[17px] border-b border-[rgba(62,121,255,0.32)]">
          <div className="flex flex-col gap-[6px]">
            <div className="size-[48px] relative">
              <img alt="NECS" className="absolute h-[48.21%] left-0 max-w-none top-[25.89%] w-full" src={imgNecs2026Logo} />
            </div>
          ...
          <div className="flex gap-[10px] items-center">
            <button className="bg-[rgba(15,58,107,0.22)] border-2 border-[rgba(62,121,255,0.32)] rounded-[14px] size-[44px] flex items-center justify-center">
        ...
        <div className="mb-4">
          ...
          >
            ...
            <div className="flex items-center justify-between pl-3">
              <div className="flex items-center gap-3">
                <div className="size-[44px] rounded-[12px] bg-[rgba(245,197,33,0.12)] border border-[rgba(245,197,33,0.35)] flex items-center justify-center">
          ...
          >
            ...
            <div className="flex items-center justify-between pl-3">
              <div className="flex items-center gap-3">
                <div className="size-[44px] rounded-[12px] bg-[rgba(62,121,255,0.12)] border border-[rgba(62,121,255,0.35)] flex items-center justify-center">
